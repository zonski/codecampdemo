...
function ac0_actor(settings) {

    this.game = game;
    this.type = 'ac0';
    this.name = 'Magic Ball';
    this.spritesheetId = 'anthro_item_light_orb';
    ...
    this.moveTowardsActor(this.target, 350);
    
} else if (this.owner) {
    
    if (!this.isNearActor(this.owner, 20)) {
        this.moveTowardsActor(this.owner, 350);
    } else {
        this.stop();
    }
