...
function ac5_actor(settings) {

    this.game = game;
    this.type = 'ac5';
    this.name = 'Pet';
    this.spritesheetId = 'dog_black_1_c20';
    ...
    var baddie = this.owner.findNearestActor('Baddie', 250);
    if (baddie) {
        
        this.showSpeechBubble('Grrr!');
        this.moveTowardsActor(baddie, 200); 
        
    } else { 
        
        this.hideSpeechBubble();
        if (!this.isNearActor(this.owner, 50)) {
            this.moveTowardsActor(this.owner, 200); 
        } else {
            this.stop();
        }
    ...
    if (this.isNearActor(player)) {
        if (player.petFood) {
            this.moveTowardsActor(player, 200);   
            this.showSpeechBubble('Woof!');
        } else {
            this.moveAwayFromActor(player, 200);   
        }
    } else {
        this.hideSpeechBubble();
    }
